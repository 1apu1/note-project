...
function AddNote() {
  ...
  const SelectedIcon = data.ico !== "" ? icons[data.ico] : null;

  return (
    <div
      className="container-fluid shadow rounded-5 pt-3"
      style={{ height: "97vh" }}
    >
      <div className="row border-bottom border-3 pe-5 pb-4">
        <div className="col-8">
          <form
            onSubmit={handleSubmit}
            className="ps-2 pe-5 d-flex flex-column gap-2"
          >
            <div>
        ...
        <div className="col-4">
          <div
            className="shadow p-3 rounded-4 d-flex flex-column align-center"
            style={{ height: "100%" }}
          >
